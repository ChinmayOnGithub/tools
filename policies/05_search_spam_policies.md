...
URL Source: http://developers.google.com/search/docs/essentials/spam-policies
...
*   **Content injection**: Hackers might also try to subtly manipulate existing pages on your site. Their goal is to add content to your site that search engines can see but which may be harder for you and your users to spot. This can involve adding [hidden links or hidden text](http://developers.google.com/search/docs/essentials/spam-policies#hidden-text-and-links) to a page by using CSS or HTML, or it can involve more complex changes like [cloaking](http://developers.google.com/search/docs/essentials/spam-policies#cloaking).
...
*   Copying content from other sites, modify it only slightly (for example, by substituting synonyms or using [automated techniques](http://developers.google.com/search/docs/essentials/spam-policies#scaled-content)), and republish it
...
*   Using affiliate links throughout a page, with [links treated appropriately](http://developers.google.com/search/docs/essentials/spam-policies#link-spam), or embedding third-party ad units throughout a page
